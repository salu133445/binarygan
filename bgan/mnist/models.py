"""Classes that define the proposed and the real-valued models."""
import os
import time
import numpy as np
...
class BinaryGAN(Model):
    """Class that defines the end-to-end model."""
    def __init__(self, sess, config, name='BinaryGAN', reuse=None):
        super().__init__(sess, config, name)

        print('[*] Building BinaryGAN...')
